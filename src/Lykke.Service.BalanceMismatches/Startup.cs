...
namespace Lykke.Service.BalanceMismatches
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        {
            ApiTitle = "BalanceMismatches API",
            ApiVersion = "v1"
        };
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "BalanceMismatchesLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.BalanceMismatchesService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("BalanceMismatches", channelOptions =>
                        {
